# BraveBoy‑MD Plugin Development Master Prompt (Repo‑Aligned)

Use this document as a **single, all‑in‑one training prompt** for an AI (or a developer) to build **production‑ready BraveBoy‑MD plugins** for this repository.

This guide is aligned with the current codebase (`index.js`, `handler.js`, `database.js`, `config.js`, `commands/*`, `utils/*`).

---

## 1) Project Architecture (How BraveBoy‑MD Works)
...
module.exports = {
  ...
  updateZipUrl: 'https://github.com/proboy315/BraveBoy-MD/archive/refs/heads/main.zip',
...
- Pairing/session:
  - Bot supports Session ID format `BraveBoy-MD!<base64gzip>`
